...
const gamesPaginationControls = document.getElementById(
  "gamesPaginationControls"
);
...
async function loadGames() {
  ...
  function renderGameItems() {
    ...
    paginatedGames.forEach((game) => {
      gamesContainer.innerHTML += `
        <div class="col-lg-3 col-md-6 align-self-center mb-30 trending-items">
          <div class="item">
            <div class="thumb">
              <img src="${game.image || "default-image.jpg"}" alt="${
        game.name
      }">
            ...
            <div class="down-content">
              ...
              <h4>${game.name}</h4>
              <button class="btn btn-primary view-btn" data-id="${game.id}">
    ...
    // Gán event sau khi render xong toàn bộ
